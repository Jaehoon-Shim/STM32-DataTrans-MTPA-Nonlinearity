...
#include "main.h"
#define HIDDEN1_NUM 12
#define HIDDEN2_NUM 12
...
extern volatile float Vcomp_NN;
extern volatile float hidden1_output[HIDDEN1_NUM];
extern volatile float hidden2_output[HIDDEN2_NUM];
